# Pritha engineering rules (full reference)

This is the complete engineering and knowledge-authoring rule set that used to
live in `AGENTS.md`. `AGENTS.md` now keeps the short, always-loaded operating
contract and links here; the sections below are unchanged in substance and stay
authoritative for the areas they cover. The original text is in Russian.
