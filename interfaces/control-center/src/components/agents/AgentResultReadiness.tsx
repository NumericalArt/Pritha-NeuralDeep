...
const resultLabels = {
  unverified: "Trials не прогнаны", verified: "Проверен", awaiting_operator: "Нужна ручная проверка",
...
export function AgentResultReadiness({ agent }: { agent: AgentCardModel }) {
  ...
  return <details className="agent-result-readiness" data-testid="agent-result-readiness">
    <summary>Результат: {resultReadinessSummary(checked.status, agent.healthStatus)}</summary>
    <dl>
