...
export function contractData(contractPath, options = {}) {
  ...
  return {
    ...
    productConstraints: bodyValue(text, "Product constraints"),
    productDataSources: bodyValue(text, "Product data sources"),
    sourceFormat: bodyValue(text, "Source format"),
    providerBinding: bodyValue(text, "Provider binding"),
    interviewPreset: String(fm.interview_preset || "generic"),
