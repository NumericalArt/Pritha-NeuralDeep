...
export function prepareCreationResearchRequest(payload, job, packet, codeRoot) {
  if(job.researchProtocolVersion===2 && packet.packet.researchProtocolVersion===2 && packet.packet.phase==='research')return {
    ...
    instructions:[
      ...
      'facts: [{topicId,sourceId,quote,versionContext,compatibility,compatibilityStatus}]. quote must be an exact contiguous 40–1200 character excerpt. versionContext names the documented version or explicitly says unversioned/current documentation. compatibility explains whether that source applies to the selected contract/runtime; compatibilityStatus is compatible, incompatible or unknown. Do not mark a conflict compatible.',
