...
export class NeuralDeepChatHistoryStore {
  ...
  creationContext(chat: string, turnId: string, maxBytes?: number, options?:{preparationVersion?:number;hasCanonicalBrief?:boolean}): {restart:boolean;text:string|null;hash:string|null};
